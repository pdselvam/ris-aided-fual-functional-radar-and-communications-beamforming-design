...
plot(theta_degree, pattern_radar_only,'--','LineWidth',2,'Color',[0.5 0.5 0.5]);
hold on;
plot(theta_degree, pattern_ris_fully(:,3),'-r','LineWidth',2);
plot(theta_degree, pattern_ris_single(:,3),'-.g','LineWidth',2);
grid on;
plot(theta_degree, pattern_baseline(:,4),':b','LineWidth',2);
