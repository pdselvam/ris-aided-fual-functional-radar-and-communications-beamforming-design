...
grid on;
legend('without RIS','RIS-aided-20 elements','RIS-aided-60 elements','RIS-aided-100 elements','FontSize',12,'interpreter','latex');
...
plot(theta_degree, pattern_ris_20(:,14),'-.g','LineWidth',2);
plot(theta_degree, pattern_ris_60(:,12),'--c','LineWidth',2);
plot(theta_degree, pattern_ris_100(:,11),'-r','LineWidth',2);
grid on;
