...
values.Mc = values.M/2; % communication antennas
values.Mr = values.M/2; % radar antennas
values.N = 20; % reflecting elements at RIS

values.Pt = 10^(20/10); % overall transmit power
values.Pc = values.Pt/2; % communication power
values.Pr = values.Pt/2; % radar power
